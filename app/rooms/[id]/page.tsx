            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-8 space-y-8">
                ...
                <div className="bg-white p-8 rounded-lg border border-[#E6DFD5] shadow-xs space-y-6">
                  <div className="flex items-center gap-6 border-b border-[#E6DFD5] pb-4 flex-wrap text-sm text-stone-700 font-semibold">
                  ...
                  <div>
                    <h4 className="font-heading text-xl font-bold text-[#1F3A2B] mb-3">
                      Included Room Amenities
                    </h4>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {room.amenities.map((amenity, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm text-stone-700 bg-[#FAF7F2] p-3 rounded border border-[#E6DFD5]">
                  ...
                  <div className="pt-4 border-t border-[#E6DFD5] text-xs sm:text-sm text-stone-500 space-y-1">
              ...
              <div className="lg:col-span-4 space-y-6">
                <div className="bg-white p-6 rounded-lg border-2 border-[#1F3A2B] shadow-md space-y-5 sticky top-24">
                  <div className="border-b border-[#E6DFD5] pb-3">
                    <span className="text-xs font-semibold text-stone-500 uppercase tracking-wider block">Starting Rate</span>
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full bg-[#1F3A2B] hover:bg-[#162B20] text-white font-semibold text-xs sm:text-sm py-3.5 px-4 rounded transition-colors shadow cursor-pointer flex items-center justify-center gap-2 tracking-wider uppercase"
                    >
                    ...
                    <a
                      ...
                      className="w-full bg-[#FAF7F2] hover:bg-[#F2ECE4] text-[#1F3A2B] border border-[#E6DFD5] font-semibold text-xs sm:text-sm py-3 px-4 rounded transition-all flex items-center justify-center gap-2"
                    >
                  ...
                  <div className="bg-[#FAF7F2] p-3 rounded text-xs text-stone-600 space-y-1 border border-[#E6DFD5]">
