  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FAF7F2] text-[#2D2B2A]">
      ...
      <main className="flex-1">
        ...
        {/* 2. ABOUT US SECTION (Image + Text + Photo Ribbon with backs.png texture) */}
        <section
          id="about"
        ...
        >
          <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center space-y-6">
            ...
            <div className="space-y-4 text-stone-600 text-sm sm:text-base leading-relaxed font-normal max-w-3xl mx-auto">
              <p>
          ...
          <div className="mt-14 mx-auto max-w-7xl px-4 sm:px-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="rounded-lg overflow-hidden border border-[#E6DFD5] aspect-4/3 bg-stone-100">
        ...
        {/* 4. FULL-WIDTH BACKGROUND IMAGE — SECTION 1 (Visual Pause: Riverfront Sunset) */}
        <section className="relative w-full h-[55vh] min-h-[380px] flex items-center justify-center overflow-hidden bg-stone-900 border-y border-[#E6DFD5]">
          <div
        ...
        <section className="py-20 sm:py-28 bg-[#FAF7F2] border-b border-[#E6DFD5]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div className="bg-white rounded-lg border border-[#E6DFD5] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center shadow-xs">
              <div className="lg:col-span-7 lg:order-2 aspect-16/10 sm:aspect-auto h-72 sm:h-104 bg-stone-100 overflow-hidden">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
              ...
              <div className="lg:col-span-5 lg:order-1 p-6 sm:p-10 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 text-xs sm:text-sm text-stone-600 pt-1">
                  {deluxeRoom.amenities.slice(0, 4).map((amenity, idx) => (
                    <span key={idx} className="bg-[#FAF7F2] px-3 py-1 rounded border border-[#E6DFD5] flex items-center gap-1.5 text-xs font-medium">
                ...
                <div className="pt-4 flex items-center gap-4">
                  <button
                    ...
                    className="bg-[#1F3A2B] hover:bg-[#162B20] text-white text-xs sm:text-sm font-semibold px-6 py-3 rounded-full transition-colors cursor-pointer uppercase tracking-wider"
                  >
                    Book Now
                  </button>
                  <Link
            ...
            {/* Alternating Row 2 */}
            <div className="bg-white rounded-lg border border-[#E6DFD5] overflow-hidden grid grid-cols-1 lg:grid-cols-12 items-center shadow-xs">
              <div className="lg:col-span-7 aspect-16/10 sm:aspect-auto h-72 sm:h-104 bg-stone-100 overflow-hidden">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={suiteRoom.image}
                  alt={suiteRoom.name}
        ...
        <section className="py-20 sm:py-28 bg-white border-b border-[#E6DFD5]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-6 rounded-lg overflow-hidden border border-[#E6DFD5] h-80 sm:h-104 bg-stone-100">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
              ...
              <div className="lg:col-span-6 space-y-5">
                ...
                <h2 className="font-heading text-3xl sm:text-4xl font-bold text-[#2D2B2A] leading-tight">
                ...
                <div className="pt-3 flex flex-wrap items-center gap-4">
                  <Link
                    href="/food"
                    className="bg-[#1F3A2B] hover:bg-[#162B20] text-white text-xs sm:text-sm font-semibold px-6 py-3 rounded-full transition-colors inline-flex items-center gap-2 uppercase tracking-wider"
                  >
                    <span>View Menu & Pricing</span>
                    <ArrowRight className="h-4 w-4" />
                  </Link>

                  <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-stone-700 bg-[#FAF7F2] px-4 py-2.5 rounded-full border border-[#E6DFD5]">
        ...
        <section className="py-20 sm:py-28 bg-[#FAF7F2] border-b border-[#E6DFD5]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white p-6 sm:p-10 rounded-lg border border-[#E6DFD5] shadow-xs">
              <div className="lg:col-span-7 rounded-lg overflow-hidden border border-[#E6DFD5] h-72 sm:h-96">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
              ...
              <div className="lg:col-span-5 space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    href="/attractions"
                    className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-[#1F3A2B] border-b border-[#1F3A2B] pb-0.5 hover:underline"
                  >
        ...
        {/* 8. FULL-WIDTH BACKGROUND IMAGE — SECTION 2 (Visual Pause: Evening Garden Courtyard Glow) */}
        <section className="relative w-full h-[55vh] min-h-[380px] flex items-center justify-center overflow-hidden bg-stone-900 border-y border-[#E6DFD5]">
          <div
            className="absolute inset-0 z-0 bg-cover bg-center"
            style={{
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
              {TESTIMONIALS_DATA.map((rev) => (
                <div key={rev.id} className="bg-[#FAF7F2] p-6 rounded-lg border border-[#E6DFD5] space-y-4 flex flex-col justify-between">
                  <p className="text-stone-700 text-sm leading-relaxed italic">
                    &ldquo;{rev.comment}&rdquo;
                  </p>
                  <div className="pt-3 border-t border-[#E6DFD5]">
                    <span className="font-bold text-[#2D2B2A] text-xs sm:text-sm block">{rev.name}</span>
            ...
            <div>
              <Link
                href="/reviews"
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-[#1F3A2B] border-b border-[#1F3A2B] pb-0.5"
              >
