    ...
    <ConfigProvider
      theme={{
        token: {
          ...
          borderRadius: 12,
          controlHeight: 44, // Tight standard height for forms & buttons
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4 sm:p-6 relative">
        ...
        <div className="w-full max-w-md bg-card border border-border rounded-3xl p-6 sm:p-8 shadow-lg space-y-5">
          ...
          <div className="flex flex-col items-center text-center space-y-3">
            ...
            <div>
              <h1 className="text-base font-bold text-foreground tracking-tight">Sign in to Workspace</h1>
              <p className="text-xs text-muted mt-1 leading-relaxed">
                Enter your credentials to access the Motimahal management portal.
              </p>
            </div>
          </div>
