    ...
    >
      ...
      <div className="mx-auto max-w-5xl px-6 text-center space-y-6 mb-14 sm:mb-18">
        ...
        <div className="space-y-5 text-stone-700 text-base sm:text-lg lg:text-xl leading-relaxed font-normal max-w-4xl mx-auto">
          <p>
            Welcome to Motimahal Lodge and Restaurant, a family-owned establishment located in Bharatpur-3, Chitwan. Established two decades ago by our family, our lodge stands as a testament to our unwavering passion for hospitality, fresh local food, and quiet rest.
          </p>
          <p>
