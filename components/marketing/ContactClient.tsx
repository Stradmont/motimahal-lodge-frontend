...
const contactSchema = z.object({
  ...
  telephone: z
    ...
    .refine((val) => isValidNepaliPhone(val), {
      message: 'Please enter a valid Nepali phone number (e.g. 9855012345 or +977 98550 12345)',
    }),
  subject: z
    .string()
    .trim()
              ...
              <div className="lg:col-span-5">
                <div className="bg-white p-8 sm:p-10 rounded-lg border border-brand-border shadow-xs space-y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <h3 className="font-heading text-lg font-bold text-brand-charcoal tracking-wide">
                      Address
                    </h3>
