                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-out pointer-events-none">
                    <div className="absolute inset-0 flex items-center justify-center p-4">
                      <div className="p-3 rounded-full bg-black/45 text-white border border-white/20 shadow-sm scale-95 group-hover:scale-100 transition-transform duration-300 ease-out backdrop-blur-xs">
