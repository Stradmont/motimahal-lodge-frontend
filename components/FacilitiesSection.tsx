...
export default function FacilitiesSection() {
  ...
  return (
    <section className="py-12 sm:py-28 border-b border-brand-border relative bg-texture">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
        <h2 className="font-heading text-2xl sm:text-4xl lg:text-6xl font-bold text-brand-charcoal tracking-wider uppercase text-center lg:text-left">
          FACILITIES
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-10">
            ...
            <div className="flex items-start gap-3.5 sm:gap-5">
              <Bookmark className="h-5 w-5 sm:h-6 sm:w-6 text-brand-green shrink-0 mt-0.5 sm:mt-1" />
              <div className="space-y-1 sm:space-y-2">
                <h3 className="font-heading text-lg sm:text-2xl font-bold text-brand-charcoal">
                  Restaurant & Dining
                </h3>
                <p className="text-stone-700 text-sm sm:text-lg leading-relaxed font-normal">
