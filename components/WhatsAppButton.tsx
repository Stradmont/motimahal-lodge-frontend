  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex items-center gap-3">
      ...
      <a
        ...
        aria-label="Chat on WhatsApp with Motimahal Lodge"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-xl hover:shadow-2xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 active:scale-95 border-2 border-white cursor-pointer group"
      >
