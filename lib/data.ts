...
export const ROOMS_DATA: Room[] = [
  {
    ...
    galleryImages: [
      '/about/room1.PNG',
      '/about/full-house-image.png',
      '/about/outside-image.png',
      '/gallery/narayani-river-gallery.jpg',
    ],
    amenities: [
      'Air Conditioning',
      'Free Wi-Fi',
  ...
  },
  {
    ...
    galleryImages: [
      '/about/single-bed-room.PNG',
      '/about/single-bed-image-1.PNG',
      '/about/outside-image.png',
      '/gallery/narayani-river-break.jpg',
    ],
    amenities: [
      'Air Conditioning',
      'Free Wi-Fi',
    ...
    description: 'Clean, well-maintained twin bedroom with air conditioning and 24/7 solar hot water for highway stopovers and Chitwan visits.',
    fullDescription: [
      'Our Standard Twin AC Room offers two separate single beds in an immaculate environment. Ideal for travel companions, safari buddies, or colleagues staying in Chitwan.',
      'Equipped with split air conditioning, attached bathroom with continuous hot water, clean cotton bedding, and complimentary high-speed Wi-Fi.',
    ],
    features: [
...
export const GALLERY_DATA: GalleryItem[] = [
  {
    ...
    caption: 'Our main lodge building featuring clean AC guest rooms and peaceful surroundings in Bharatpur.',
    aspect: 'aspect-16/10',
  },
  {
    id: 'narayani-sunset',
  ...
  },
  {
    ...
    category: 'Rooms',
    image: '/about/room1.PNG',
    caption: 'Spacious air-conditioned bedroom with clean linen and peaceful garden view.',
    aspect: 'aspect-4/3',
  },
  {
    id: 'lodge-courtyard',
    title: 'Lodge Entrance & Garden Courtyard',
    category: 'Lodge & Grounds',
  ...
  {
    id: 'host-family-welcoming',
    title: 'Warm Family Hospitality',
    category: 'Hospitality',
    image: '/about/owner-image.png',
    caption: '20+ years of dedicated family hospitality serving travelers and safari guests.',
    aspect: 'aspect-4/3',
  },
  {
    id: 'standard-twin-room',
    title: 'Standard Twin / Single Bed Room',
    category: 'Rooms',
    image: '/about/single-bed-room.PNG',
    caption: 'Clean, well-maintained twin bed room ideal for solo travelers and pairs.',
    aspect: 'aspect-4/3',
  },
  {
    id: 'spacious-bedroom-setup',
    title: 'Comfortable Bedroom Interior & Amenities',
    category: 'Rooms',
    image: '/about/single-bed-image-1.PNG',
    caption: 'Fresh linens, daily housekeeping, and peaceful space for travel rest.',
    aspect: 'aspect-4/3',
  },
  {
    id: 'lodge-family-desk',
    title: 'Motimahal Host Family Service',
    category: 'Hospitality',
    image: '/about/owner-side-image.png',
    caption: 'Personalized assistance for room bookings and Chitwan safari arrangements.',
    aspect: 'aspect-4/3',
  },
  {
    id: 'narayani-riverfront-walkway',
    title: 'Narayani River Promenade & Walkway',
    category: 'Narayani & Chitwan',
    image: '/gallery/narayani-river-break.jpg',
    caption: 'Gentle river breezes and scenic walking paths near Narayangadh, Bharatpur.',
    aspect: 'aspect-16/10',
  },
];
